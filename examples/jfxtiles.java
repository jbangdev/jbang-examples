...
//JAVA 21+
//DEPS eu.hansolo:tilesfx:21.0.9
//FILES eu/hansolo/tilesfx/=https://github.com/HanSolo/tilesfx/blob/jdk21/src/main/resources/eu/hansolo/tilesfx/HanSolo.png?raw=true
/*
...
import eu.hansolo.fx.heatmap.Demo;
...
public class jfxtiles extends Application {
    ...
    @Override public void init() {
        ...
        imageTile = TileBuilder.create()
                                ...
                                .prefSize(TILE_WIDTH, TILE_HEIGHT)
                                .title("Image Tile")
                                .image(new Image(jfxtiles.class.getResourceAsStream("HanSolo.png")))
